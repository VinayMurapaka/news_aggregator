...
          <li><Link className="no-underline font-semibold" to="/" onClick={closeMenu}>All News</Link></li>
          
...
                return (
                  <li key={index} onClick={() => { setShowCategoryDropdown(!showCategoryDropdown); closeMenu(); }}>
...
                return (
                  <li key={index} onClick={() => { setShowCountryDropdown(!showCountryDropdown); closeMenu(); }}>
...
          </li>
          ...
          {/* Conditional Saved Link */}
          {isAuthenticated && (
          <li><Link to="/saved" className="no-underline font-semibold" onClick={closeMenu}>Saved</Link></li>
          )}
          ...
          <li>
            {isAuthenticated ? (
                <button 
                  ...
                  className="px-3 py-1 bg-red-600 hover:bg-red-700 text-white rounded-md font-semibold transition duration-150"
                >
                  Logout
                </button>
            ) : (
                <button 
                  ...
                  className="px-3 py-1 bg-indigo-600 hover:bg-indigo-700 text-white rounded-md font-semibold transition duration-150"
                >
                  Login
                </button>
            )}
